...
public class Board {
	...
	public Board(int boardnum, String id, String title, String content, String inputdate, int hits, String orginalfile,
			String savedfile) {
	...
	public String toString() {
		return "Board [boardnum=" + boardnum + ", id=" + id + ", title=" + title + ", content=" + content
				+ ", inputdate=" + inputdate + ", hits=" + hits + ", orginalfile=" + orginalfile + ", savedfile="
				+ savedfile + "]";
	}
